...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		levelInfo.setFormat(Paths.font("determination.otf"), 32);
		...
		levelDifficulty.setFormat(Paths.font("determination.otf"), 32);
		...
		heals.setFormat(Paths.font("determination.otf"), 32);
		heals.updateHitbox();
		add(heals);
		...
		FlxTween.tween(bg, {alpha: 0.8}, 0.7, {ease: FlxEase.quartInOut});
		...
		perSongOffset.setFormat(Paths.font("determination.otf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
